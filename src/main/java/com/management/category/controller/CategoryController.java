...
public class CategoryController {
    ...
    public void registNewCategory(CategoryDTO category) {
        ...
        if (result) {
            categoryPrint.printSuccessMessage("객체를 통해 등록 성공했습니다.");
        } else {
            categoryPrint.printErrorMessage("객체를 통해 등록 실패했습니다.");
        }
    }
    ...
    public void modifyCategoryName(CategoryDTO category) {
        ...
        if (result) {
            categoryPrint.printSuccessMessage("객체를 통해 수정 성공했습니다.");
        } else {
            categoryPrint.printErrorMessage("객체를 통해 수정 실패했습니다.");
        }
    }
    ...
    public void deleteCategory(Map<String, String> parameter) {
        ...
        if (result) {
            categoryPrint.printSuccessMessage("객체를 통해 삭제 성공했습니다.");
        } else {
            categoryPrint.printErrorMessage("객체를 통해 삭제 실패했습니다.");
        }
    }
}
